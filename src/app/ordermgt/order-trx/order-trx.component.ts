...
@Component({
  selector: 'app-order-trx',
  templateUrl: './order-trx.component.html',
  styleUrls: ['./order-trx.component.css']
})
export class OrderTrxComponent implements OnInit {
  ...
  onItemDetails(data){
    ...
    this.router.navigate(['../orderitem'],
       { 
         ...
         queryParams: { orderno: data.orderNo,viewonly:true  }
       });
  }
